        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    acceso_directo = table.Column<int>(type: "int", nullable: true),
                    orden = table.Column<int>(type: "int", nullable: true),
                    desplegable = table.Column<int>(type: "int", nullable: true),
                    id_modulo = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    padre = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    finalizado = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    padre = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    tipo_componente = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    ...
                    background_color = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    agregar_fondo = table.Column<int>(type: "int", nullable: true),
                    titulo = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    subtitulo = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    orden = table.Column<int>(type: "int", nullable: true),
                    id_modulo = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
